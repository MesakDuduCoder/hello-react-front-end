...
Hello react front end is a simple app for displaying a greeting from a rails api.
...
```sh
  git clone https://github.com/MesakDuduCoder/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/MesakDuduCoder/hello_react_front_end/issues).
